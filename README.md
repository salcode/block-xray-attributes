...
* Render block information in "Block" settings rather than "Post" settings ([#33 Render block information in "Block" settings](https://github.com/salcode/block-xray-attributes/issues/33))
